...
\lstdefinelanguage{neu}{
  keywords={fn, let, in, if, then, else, true, false, type, contract, rule, learn, epiplexity, split, scatter, decompose, cover, shift, cast, synthesis, analysis, transformation},
...
We have established the theoretical foundations and syntactic blueprint for \texttt{learn} and \texttt{epiplexity} in Neu:
\begin{itemize}
    ...
    \item \textbf{Computationally Bounded Information:} Extending beyond asymptotic Shannon entropy with Two-Part MDL Epiplexity profiling and compile-time certification.
\end{itemize}
