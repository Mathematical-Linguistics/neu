...
\author{\textbf{Erick Olusoji Oduniyi}\\[0.3em]
\textit{Mathematical Linguistics Group (mL-G) $\cdot$ Intelligent Interfaces Group (IIG)}\\[0.2em]
\texttt{community@intelligent-interfaces.org}}
\date{September 2026}
...
At the \textbf{Mathematical Linguistics Group (mL-G)}, we reject this separation. Drawing from the architectural lineage of the MIT Media Lab (MedRec, Viral Communications) and the Intelligent Interfaces Group (IIG), we treat formal grammars, physical signals, and biological state spaces as manifestations of a single, unified medium. We have engineered \textbf{Neu}: a polyglot language that makes information-theoretic entropy bounds, algebraic contracts, and hardware data-plane deployment first-class primitives.
...
The Mathematical Linguistics Group will advance Neu along three trajectories:
\begin{enumerate}
